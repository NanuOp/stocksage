...
const StockDetailsPage = () => {
  ...
  useEffect(() => {
    fetchStockDetails();
    const interval = setInterval(fetchStockDetails, 60000); // API call every 1 minute
    ...
    <>
      ...
      >
        ...
        <Grid container spacing={3}>
          {/* Financials */}
          {stockData.trailingPE && stockData.marketCap && (
          ...
          {/* Stock Performance (Adjusted height to match Trading Volume) */}
